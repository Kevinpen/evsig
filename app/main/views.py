...
from . import main, sig, zfplot
from app import load_data
datasets,datasets_name,examples = g.datasets, g.datasets_name, g.examples
...
@main.route('/search',methods=['POST','GET']) #Response for yeast search
def search():
